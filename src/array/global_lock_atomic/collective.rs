    ...
    array::{
        collective::{
            ...
            reduce_handle::{
                ...
                ArrayCollectiveAllReduceIntoBufferHandle, ArrayCollectiveAllReduceIntoBufferState,
                ArrayCollectiveAllReduceState, ArrayCollectiveReduceHandle,
                ArrayCollectiveReduceIntoBufferHandle, ArrayCollectiveReduceIntoBufferState,
                ArrayCollectiveReduceState, CollectiveAllReduceIntoBufferManualOpHandle,
                CollectiveAllReduceManualOpHandle, CollectiveReduceIntoBufferManualOpHandle,
        ...
        global_lock_atomic::GlobalLockCollectiveMutLocalData,
...
impl<T: ElementArithmeticOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn sum_all(&self, index: usize, len: usize) -> ArrayCollectiveAllReduceHandle<T> {
        if !self.array.array.collective_support.all_sum {
                ...
                state: ArrayCollectiveAllReduceState::CollectiveAllReduceManual(
                    CollectiveAllReduceManualOpHandle {
                        future: Box::pin(do_all_reduce(
                            self.array.clone(),
                            self.array.array.inner.data.mem_region.scheduler.clone(),
                            sync_alloc,
                            my_ticket,
                            now_serving,
                            index,
            ...
            unsafe { self.array.array.sum_all(index, len) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn prod_all(&self, index: usize, len: usize) -> ArrayCollectiveAllReduceHandle<T> {
        if !self.array.array.collective_support.all_prod {
            ...
            unsafe { self.array.array.prod_all(index, len) }
        }
    }
}
...
impl<T: ElementComparePartialEqOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn max_all(&self, index: usize, len: usize) -> ArrayCollectiveAllReduceHandle<T> {
        if !self.array.array.collective_support.all_max {
            ...
            unsafe { self.array.array.max_all(index, len) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn min_all(&self, index: usize, len: usize) -> ArrayCollectiveAllReduceHandle<T> {
        if !self.array.array.collective_support.all_min {
            ...
            unsafe { self.array.array.min_all(index, len) }
        }
    }
}
...
impl<T: ElementBitWiseOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn bit_and_all(&self, index: usize, len: usize) -> ArrayCollectiveAllReduceHandle<T> {
        if !self.array.array.collective_support.all_bit_and {
            ...
            unsafe { self.array.array.bit_and_all(index, len) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn bit_or_all(&self, index: usize, len: usize) -> ArrayCollectiveAllReduceHandle<T> {
        if !self.array.array.collective_support.all_bit_or {
            ...
            unsafe { self.array.array.bit_or_all(index, len) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn bit_xor_all(&self, index: usize, len: usize) -> ArrayCollectiveAllReduceHandle<T> {
        if !self.array.array.collective_support.all_bit_xor {
            ...
            unsafe { self.array.array.bit_xor_all(index, len) }
        }
    }
}
...
impl<T: ElementArithmeticOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    ///```
    pub fn sum_all_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        ...
        if !self.array.array.collective_support.all_sum {
            ...
            unsafe { self.array.array.sum_all_into_buffer(index, len, buffer) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    ///```
    pub fn prod_all_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
        ...
        if !self.array.array.collective_support.all_prod {
            ...
            unsafe { self.array.array.prod_all_into_buffer(index, len, buffer) }
        }
    }
}
...
impl<T: ElementComparePartialEqOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    ///```
    pub fn max_all_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
        ...
        if !self.array.array.collective_support.all_max {
            ...
            unsafe { self.array.array.max_all_into_buffer(index, len, buffer) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    ///```
    pub fn min_all_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
        ...
        if !self.array.array.collective_support.all_min {
            ...
            unsafe { self.array.array.min_all_into_buffer(index, len, buffer) }
        }
    }
}
...
impl<T: ElementBitWiseOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    ///```
    pub fn bit_and_all_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
        ...
        if !self.array.array.collective_support.all_bit_and {
            ...
            unsafe { self.array.array.bit_and_all_into_buffer(index, len, buffer) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    ///```
    pub fn bit_or_all_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
        ...
        if !self.array.array.collective_support.all_bit_or {
            ...
            unsafe { self.array.array.bit_or_all_into_buffer(index, len, buffer) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    ///```
    pub fn bit_xor_all_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
        ...
        if !self.array.array.collective_support.all_bit_xor {
            ...
            unsafe { self.array.array.bit_xor_all_into_buffer(index, len, buffer) }
        }
    }
}
...
impl<T: Dist + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    ///```
    pub fn sum_all_in_place<B: AsLamellarBuffer<T>>(
        &self,
        src_and_dst: LamellarBuffer<T, B>,
    ) -> ArrayCollectiveAllReduceInPlaceHandle<T, B> {
        unsafe { self.array.array.sum_all_in_place(src_and_dst) }
    }
    /// # Examples
    ///```no_run
    /// use lamellar::array::prelude::*;
    ...
    ///```
    pub fn max_all_in_place<B: AsLamellarBuffer<T>>(
        &self,
        src_and_dst: LamellarBuffer<T, B>,
    ) -> ArrayCollectiveAllReduceInPlaceHandle<T, B> {
        unsafe { self.array.array.max_all_in_place(src_and_dst) }
    }
    /// # Examples
    ///```no_run
    /// use lamellar::array::prelude::*;
    ...
    ///```
    pub fn min_all_in_place<B: AsLamellarBuffer<T>>(
        &self,
        src_and_dst: LamellarBuffer<T, B>,
    ) -> ArrayCollectiveAllReduceInPlaceHandle<T, B> {
        unsafe { self.array.array.min_all_in_place(src_and_dst) }
    }
    /// # Examples
    ///```no_run
    /// use lamellar::array::prelude::*;
    ...
    ///```
    pub fn prod_all_in_place<B: AsLamellarBuffer<T>>(
        &self,
        src_and_dst: LamellarBuffer<T, B>,
    ) -> ArrayCollectiveAllReduceInPlaceHandle<T, B> {
        unsafe { self.array.array.prod_all_in_place(src_and_dst) }
    }
    /// # Examples
    ///```no_run
    /// use lamellar::array::prelude::*;
    ...
    ///```
    pub fn bit_and_all_in_place<B: AsLamellarBuffer<T>>(
        &self,
        src_and_dst: LamellarBuffer<T, B>,
    ) -> ArrayCollectiveAllReduceInPlaceHandle<T, B> {
        unsafe { self.array.array.bit_and_all_in_place(src_and_dst) }
    }
    /// # Examples
    ///```no_run
    /// use lamellar::array::prelude::*;
    ...
    ///```
    pub fn bit_or_all_in_place<B: AsLamellarBuffer<T>>(
        &self,
        src_and_dst: LamellarBuffer<T, B>,
    ) -> ArrayCollectiveAllReduceInPlaceHandle<T, B> {
        unsafe { self.array.array.bit_or_all_in_place(src_and_dst) }
    }
    /// # Examples
    ///```no_run
    /// use lamellar::array::prelude::*;
    ...
    ///```
    pub fn bit_xor_all_in_place<B: AsLamellarBuffer<T>>(
        &self,
        src_and_dst: LamellarBuffer<T, B>,
    ) -> ArrayCollectiveAllReduceInPlaceHandle<T, B> {
        unsafe { self.array.array.bit_xor_all_in_place(src_and_dst) }
    }
}
...
impl<T: ElementArithmeticOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn sum_at_pe(&self, index: usize, len: usize, pe: usize) -> ArrayCollectiveReduceHandle<T> {
        if !self.array.array.collective_support.sum {
            ...
            unsafe { self.array.array.sum_at_pe(index, len, pe) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn prod_at_pe(
        ...
        if !self.array.array.collective_support.prod {
            ...
            unsafe { self.array.array.prod_at_pe(index, len, pe) }
        }
    }
}
...
impl<T: ElementComparePartialEqOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn max_at_pe(&self, index: usize, len: usize, pe: usize) -> ArrayCollectiveReduceHandle<T> {
        if !self.array.array.collective_support.max {
            ...
            unsafe { self.array.array.max_at_pe(index, len, pe) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn min_at_pe(&self, index: usize, len: usize, pe: usize) -> ArrayCollectiveReduceHandle<T> {
        if !self.array.array.collective_support.min {
            ...
            unsafe { self.array.array.min_at_pe(index, len, pe) }
        }
    }
}
...
impl<T: ElementBitWiseOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn bit_and_at_pe(
        ...
        if !self.array.array.collective_support.bit_and {
            ...
            unsafe { self.array.array.bit_and_at_pe(index, len, pe) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn bit_or_at_pe(
        ...
        if !self.array.array.collective_support.bit_or {
            ...
            unsafe { self.array.array.bit_or_at_pe(index, len, pe) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn bit_xor_at_pe(
        ...
        if !self.array.array.collective_support.bit_xor {
            ...
            unsafe { self.array.array.bit_xor_at_pe(index, len, pe) }
        }
    }
}
...
impl<T: ElementArithmeticOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn sum_at_pe_into_buffer<B: AsLamellarBuffer<T>>(
        ...
        if !self.array.array.collective_support.sum {
            ...
            unsafe { self.array.array.sum_at_pe_into_buffer(index, len, target) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn prod_at_pe_into_buffer<B: AsLamellarBuffer<T>>(
        ...
        if !self.array.array.collective_support.prod {
            ...
            unsafe { self.array.array.prod_at_pe_into_buffer(index, len, target) }
        }
    }
}
...
impl<T: ElementComparePartialEqOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn max_at_pe_into_buffer<B: AsLamellarBuffer<T>>(
        ...
        if !self.array.array.collective_support.max {
            ...
            unsafe { self.array.array.max_at_pe_into_buffer(index, len, target) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn min_at_pe_into_buffer<B: AsLamellarBuffer<T>>(
        ...
        if !self.array.array.collective_support.min {
            ...
            unsafe { self.array.array.min_at_pe_into_buffer(index, len, target) }
        }
    }
}
...
impl<T: Dist + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn gather_all(&self, index: usize, len: usize) -> ArrayCollectiveAllGatherHandle<T> {
        if !self.array.array.collective_support.allgather {
            ...
            unsafe { self.array.array.gather_all(index, len) }
        }
    }
    ...
    ///```
    pub fn gather_all_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
        ...
        if !self.array.array.collective_support.allgather {
            ...
            unsafe { self.array.array.gather_all_into_buffer(index, len, buffer) }
        }
    }
}
...
impl<T: Dist + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn gather_at_pe(
        ...
        if !self.array.array.collective_support.gather {
            ...
            unsafe { self.array.array.gather_at_pe(index, len, pe) }
        }
    }
...
impl<T: Dist + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn broadcast_all(&self, index: usize, len: usize) -> ArrayCollectiveAllToAllHandle<T> {
        if !self.array.array.collective_support.alltoall {
            ...
            unsafe { self.array.array.alltoall(index, len) }
        }
    }
    ...
    ///```
    pub fn broadcast_all_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
        ...
        if !self.array.array.collective_support.alltoall {
            ...
            unsafe { self.array.array.alltoall_into_buffer(index, len, buffer) }
        }
    }
}
...
impl<T: Dist + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn broadcast_from_pe_into_buffer<B: AsLamellarBuffer<T>>(
        ...
        if !self.array.array.collective_support.broadcast {
            ...
            unsafe { self.array.array.broadcast_from_pe_into_buffer(target, len) }
        }
    }
}
...
impl<T: Dist + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn scatter_from_pe(
        ...
        if !self.array.array.collective_support.scatter {
            ...
            unsafe { self.array.array.scatter_from_pe(src_or_root_pe, len) }
        }
    }
    ...
    ///```
    pub fn scatter_from_pe_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
...
impl<T: ElementArithmeticOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn sum_scatter(&self, index: usize, len: usize) -> ArrayCollectiveReduceScatterHandle<T> {
        if !self.array.array.collective_support.sum_scatter {
            ...
            unsafe { self.array.array.sum_scatter(index, len) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn prod_scatter(&self, index: usize, len: usize) -> ArrayCollectiveReduceScatterHandle<T> {
        if !self.array.array.collective_support.prod_scatter {
            ...
            unsafe { self.array.array.prod_scatter(index, len) }
        }
    }
}
...
impl<T: ElementComparePartialEqOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn max_scatter(&self, index: usize, len: usize) -> ArrayCollectiveReduceScatterHandle<T> {
        if !self.array.array.collective_support.max_scatter {
            ...
            unsafe { self.array.array.max_scatter(index, len) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn min_scatter(&self, index: usize, len: usize) -> ArrayCollectiveReduceScatterHandle<T> {
        if !self.array.array.collective_support.min_scatter {
            ...
            unsafe { self.array.array.min_scatter(index, len) }
        }
    }
}
...
impl<T: ElementBitWiseOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    pub fn bit_and_scatter(
        ...
        if !self.array.array.collective_support.bit_and_scatter {
            ...
            unsafe { self.array.array.bit_and_scatter(index, len) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn bit_or_scatter(
        ...
        if !self.array.array.collective_support.bit_or_scatter {
            ...
            unsafe { self.array.array.bit_or_scatter(index, len) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    pub fn bit_xor_scatter(
        ...
        if !self.array.array.collective_support.bit_xor_scatter {
            ...
            unsafe { self.array.array.bit_xor_scatter(index, len) }
        }
    }
}
...
impl<T: ElementArithmeticOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    ///```
    pub fn sum_scatter_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
        ...
        if !self.array.array.collective_support.sum_scatter {
            ...
            unsafe { self.array.array.sum_scatter_into_buffer(index, len, buffer) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    ///```
    pub fn prod_scatter_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
...
impl<T: ElementComparePartialEqOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    ///```
    pub fn max_scatter_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
        ...
        if !self.array.array.collective_support.max_scatter {
            ...
            unsafe { self.array.array.max_scatter_into_buffer(index, len, buffer) }
        }
    }
    /// # Examples
    ///```no_run
    ...
    ///```
    pub fn min_scatter_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
        ...
        if !self.array.array.collective_support.min_scatter {
            ...
            unsafe { self.array.array.min_scatter_into_buffer(index, len, buffer) }
        }
    }
}
...
impl<T: ElementBitWiseOps + Default> GlobalLockCollectiveMutLocalData<T> {
    ...
    ///```
    pub fn bit_and_scatter_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
    ...
    ///```
    pub fn bit_or_scatter_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
    ...
    ///```
    pub fn bit_xor_scatter_into_buffer<B: AsLamellarBuffer<T>>(
        &self,
        index: usize,
        len: usize,
        buffer: LamellarBuffer<T, B>,
