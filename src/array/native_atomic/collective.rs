use crate::{AsLamellarBuffer, Dist, ElementArithmeticOps, ElementBitWiseOps, ElementComparePartialEqOps, LamellarBuffer, LamellarEnv, array::{NativeAtomicArray,
    collective::{
...
impl<T: ElementArithmeticOps + Default> NativeAtomicArray<T> {
    ...
    /// let array: NativeAtomicArray<usize> = NativeAtomicArray::new(&world, world.num_pes(), Distribution::Block).block();
    /// world.barrier();
