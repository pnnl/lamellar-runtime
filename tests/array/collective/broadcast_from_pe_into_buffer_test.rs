...
fn main() {
    ...
    match array.as_str() {
        "AtomicArray" => match elem.as_str() {
            ...
            "u32" => broadcast_from_pe_into_buffer_test!(AtomicArray, u32, len, dist_type),
            "u64" => broadcast_from_pe_into_buffer_test!(AtomicArray, u64, len, dist_type),
            "u128" => broadcast_from_pe_into_buffer_test!(AtomicArray, u128, len, dist_type),
            "usize" => broadcast_from_pe_into_buffer_test!(AtomicArray, usize, len, dist_type),
            "i8" => broadcast_from_pe_into_buffer_test!(AtomicArray, i8, len, dist_type),
            "i16" => broadcast_from_pe_into_buffer_test!(AtomicArray, i16, len, dist_type),
            "i32" => broadcast_from_pe_into_buffer_test!(AtomicArray, i32, len, dist_type),
            "i64" => broadcast_from_pe_into_buffer_test!(AtomicArray, i64, len, dist_type),
            "i128" => broadcast_from_pe_into_buffer_test!(AtomicArray, i128, len, dist_type),
