...
fn main() {
    ...
    match array.as_str() {
        ...
        "AtomicArray" => match elem.as_str() {
            ...
            "u32" => bit_and_all_test!(AtomicArray, u32, len, dist_type),
            "u64" => bit_and_all_test!(AtomicArray, u64, len, dist_type),
            "u128" => bit_and_all_test!(AtomicArray, u128, len, dist_type),
            "usize" => bit_and_all_test!(AtomicArray, usize, len, dist_type),
            "i8" => bit_and_all_test!(AtomicArray, i8, len, dist_type),
            "i16" => bit_and_all_test!(AtomicArray, i16, len, dist_type),
            "i32" => bit_and_all_test!(AtomicArray, i32, len, dist_type),
            "i64" => bit_and_all_test!(AtomicArray, i64, len, dist_type),
            "i128" => bit_and_all_test!(AtomicArray, i128, len, dist_type),
            "isize" => bit_and_all_test!(AtomicArray, isize, len, dist_type),
            "f32" => bit_and_all_test!(AtomicArray, f32, len, dist_type),
            "f64" => bit_and_all_test!(AtomicArray, f64, len, dist_type),
            _ => eprintln!("unsupported element type"),
        },
