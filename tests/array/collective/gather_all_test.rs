...
fn main() {
    ...
    match array.as_str() {
        ...
        //     "u16" => gather_all_test!(LocalLockArray, u16, len, dist_type),
        //     "u32" => gather_all_test!(LocalLockArray, u32, len, dist_type),
        //     "u64" => gather_all_test!(LocalLockArray, u64, len, dist_type),
        //     "u128" => gather_all_test!(LocalLockArray, u128, len, dist_type),
        //     "usize" => gather_all_test!(LocalLockArray, usize, len, dist_type),
        //     "i8" => gather_all_test!(LocalLockArray, i8, len, dist_type),
        //     "i16" => gather_all_test!(LocalLockArray, i16, len, dist_type),
        //     "i32" => gather_all_test!(LocalLockArray, i32, len, dist_type),
        //     "i64" => gather_all_test!(LocalLockArray, i64, len, dist_type),
        //     "i128" => gather_all_test!(LocalLockArray, i128, len, dist_type),
        //     "isize" => gather_all_test!(LocalLockArray, isize, len, dist_type),
        //     "f32" => gather_all_test!(LocalLockArray, f32, len, dist_type),
