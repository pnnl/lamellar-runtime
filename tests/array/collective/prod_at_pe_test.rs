...
//             "u8" => prod_at_pe_test!(UnsafeArray, u8, len, dist_type),
//             "u16" => prod_at_pe_test!(UnsafeArray, u16, len, dist_type),
//             "u32" => prod_at_pe_test!(UnsafeArray, u32, len, dist_type),
//             "u64" => prod_at_pe_test!(UnsafeArray, u64, len, dist_type),
//             "u128" => prod_at_pe_test!(UnsafeArray, u128, len, dist_type),
//             "usize" => prod_at_pe_test!(UnsafeArray, usize, len, dist_type),
//             "i8" => prod_at_pe_test!(UnsafeArray, i8, len, dist_type),
//             "i16" => prod_at_pe_test!(UnsafeArray, i16, len, dist_type),
//             "i32" => prod_at_pe_test!(UnsafeArray, i32, len, dist_type),
//             "i64" => prod_at_pe_test!(UnsafeArray, i64, len, dist_type),
//             "i128" => prod_at_pe_test!(UnsafeArray, i128, len, dist_type),
//             "isize" => prod_at_pe_test!(UnsafeArray, isize, len, dist_type),
//             "f32" => prod_at_pe_test!(UnsafeArray, f32, len, dist_type),
//             "f64" => prod_at_pe_test!(UnsafeArray, f64, len, dist_type),
//             _ => eprintln!("unsupported element type"),
//         },
//         "AtomicArray" => match elem.as_str() {
//             "u8" => prod_at_pe_test!(AtomicArray, u8, len, dist_type),
//             "u16" => prod_at_pe_test!(AtomicArray, u16, len, dist_type),
//             "u32" => prod_at_pe_test!(AtomicArray, u32, len, dist_type),
//             "u64" => prod_at_pe_test!(AtomicArray, u64, len, dist_type),
//             "u128" => prod_at_pe_test!(AtomicArray, u128, len, dist_type),
//             "usize" => prod_at_pe_test!(AtomicArray, usize, len, dist_type),
//             "i8" => prod_at_pe_test!(AtomicArray, i8, len, dist_type),
//             "i16" => prod_at_pe_test!(AtomicArray, i16, len, dist_type),
//             "i32" => prod_at_pe_test!(AtomicArray, i32, len, dist_type),
//             "i64" => prod_at_pe_test!(AtomicArray, i64, len, dist_type),
//             "i128" => prod_at_pe_test!(AtomicArray, i128, len, dist_type),
//             "isize" => prod_at_pe_test!(AtomicArray, isize, len, dist_type),
//             "f32" => prod_at_pe_test!(AtomicArray, f32, len, dist_type),
//             "f64" => prod_at_pe_test!(AtomicArray, f64, len, dist_type),
//             _ => eprintln!("unsupported element type"),
//         },
//         // "LocalLockArray" => match elem.as_str() {
//         //     "u8" => prod_at_pe_test!(LocalLockArray, u8, len, dist_type),
//         //     "u16" => prod_at_pe_test!(LocalLockArray, u16, len, dist_type),
//         //     "u32" => prod_at_pe_test!(LocalLockArray, u32, len, dist_type),
//         //     "u64" => prod_at_pe_test!(LocalLockArray, u64, len, dist_type),
//         //     "u128" => prod_at_pe_test!(LocalLockArray, u128, len, dist_type),
//         //     "usize" => prod_at_pe_test!(LocalLockArray, usize, len, dist_type),
//         //     "i8" => prod_at_pe_test!(LocalLockArray, i8, len, dist_type),
//         //     "i16" => prod_at_pe_test!(LocalLockArray, i16, len, dist_type),
//         //     "i32" => prod_at_pe_test!(LocalLockArray, i32, len, dist_type),
//         //     "i64" => prod_at_pe_test!(LocalLockArray, i64, len, dist_type),
//         //     "i128" => prod_at_pe_test!(LocalLockArray, i128, len, dist_type),
//         //     "isize" => prod_at_pe_test!(LocalLockArray, isize, len, dist_type),
//         //     "f32" => prod_at_pe_test!(LocalLockArray, f32, len, dist_type),
