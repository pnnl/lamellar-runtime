...
fn main() {
    ...
    match array.as_str() {
        "UnsafeArray" => match elem.as_str() {
            "u8" => fetch_div_test!(UnsafeArray, u8, len, dist_type),
            "u16" => fetch_div_test!(UnsafeArray, u16, len, dist_type),
            "u32" => fetch_div_test!(UnsafeArray, u32, len, dist_type),
            "u64" => fetch_div_test!(UnsafeArray, u64, len, dist_type),
            "u128" => fetch_div_test!(UnsafeArray, u128, len, dist_type),
            "usize" => fetch_div_test!(UnsafeArray, usize, len, dist_type),
            "i8" => fetch_div_test!(UnsafeArray, i8, len, dist_type),
            "i16" => fetch_div_test!(UnsafeArray, i16, len, dist_type),
            "i32" => fetch_div_test!(UnsafeArray, i32, len, dist_type),
            "i64" => fetch_div_test!(UnsafeArray, i64, len, dist_type),
            "i128" => fetch_div_test!(UnsafeArray, i128, len, dist_type),
            "isize" => fetch_div_test!(UnsafeArray, isize, len, dist_type),
            "f32" => fetch_div_test!(UnsafeArray, f32, len, dist_type),
            "f64" => fetch_div_test!(UnsafeArray, f64, len, dist_type),
            _ => eprintln!("unsupported element type"),
        },
        "AtomicArray" => match elem.as_str() {
            "u8" => fetch_div_test!(AtomicArray, u8, len, dist_type),
            "u16" => fetch_div_test!(AtomicArray, u16, len, dist_type),
            "u32" => fetch_div_test!(AtomicArray, u32, len, dist_type),
            "u64" => fetch_div_test!(AtomicArray, u64, len, dist_type),
            "u128" => fetch_div_test!(AtomicArray, u128, len, dist_type),
            "usize" => fetch_div_test!(AtomicArray, usize, len, dist_type),
            "i8" => fetch_div_test!(AtomicArray, i8, len, dist_type),
            "i16" => fetch_div_test!(AtomicArray, i16, len, dist_type),
            "i32" => fetch_div_test!(AtomicArray, i32, len, dist_type),
            "i64" => fetch_div_test!(AtomicArray, i64, len, dist_type),
            "i128" => fetch_div_test!(AtomicArray, i128, len, dist_type),
            "isize" => fetch_div_test!(AtomicArray, isize, len, dist_type),
            "f32" => fetch_div_test!(AtomicArray, f32, len, dist_type),
            "f64" => fetch_div_test!(AtomicArray, f64, len, dist_type),
            _ => eprintln!("unsupported element type"),
        },
        "LocalLockAtomicArray" => match elem.as_str() {
            "u8" => fetch_div_test!(LocalLockAtomicArray, u8, len, dist_type),
            "u16" => fetch_div_test!(LocalLockAtomicArray, u16, len, dist_type),
            "u32" => fetch_div_test!(LocalLockAtomicArray, u32, len, dist_type),
            "u64" => fetch_div_test!(LocalLockAtomicArray, u64, len, dist_type),
            "u128" => fetch_div_test!(LocalLockAtomicArray, u128, len, dist_type),
            "usize" => fetch_div_test!(LocalLockAtomicArray, usize, len, dist_type),
            "i8" => fetch_div_test!(LocalLockAtomicArray, i8, len, dist_type),
            "i16" => fetch_div_test!(LocalLockAtomicArray, i16, len, dist_type),
            "i32" => fetch_div_test!(LocalLockAtomicArray, i32, len, dist_type),
            "i64" => fetch_div_test!(LocalLockAtomicArray, i64, len, dist_type),
            "i128" => fetch_div_test!(LocalLockAtomicArray, i128, len, dist_type),
            "isize" => fetch_div_test!(LocalLockAtomicArray, isize, len, dist_type),
            "f32" => fetch_div_test!(LocalLockAtomicArray, f32, len, dist_type),
            "f64" => fetch_div_test!(LocalLockAtomicArray, f64, len, dist_type),
            _ => eprintln!("unsupported element type"),
        },
