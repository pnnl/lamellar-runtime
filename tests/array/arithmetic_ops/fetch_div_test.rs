...
fn main() {
    ...
    match array.as_str() {
        ...
        "LocalLockArray" => match elem.as_str() {
            "u8" => fetch_div_test!(LocalLockArray, u8, len, dist_type),
            "u16" => fetch_div_test!(LocalLockArray, u16, len, dist_type),
            "u32" => fetch_div_test!(LocalLockArray, u32, len, dist_type),
            "u64" => fetch_div_test!(LocalLockArray, u64, len, dist_type),
            "u128" => fetch_div_test!(LocalLockArray, u128, len, dist_type),
            "usize" => fetch_div_test!(LocalLockArray, usize, len, dist_type),
            "i8" => fetch_div_test!(LocalLockArray, i8, len, dist_type),
            "i16" => fetch_div_test!(LocalLockArray, i16, len, dist_type),
            "i32" => fetch_div_test!(LocalLockArray, i32, len, dist_type),
            "i64" => fetch_div_test!(LocalLockArray, i64, len, dist_type),
            "i128" => fetch_div_test!(LocalLockArray, i128, len, dist_type),
            "isize" => fetch_div_test!(LocalLockArray, isize, len, dist_type),
            "f32" => fetch_div_test!(LocalLockArray, f32, len, dist_type),
            "f64" => fetch_div_test!(LocalLockArray, f64, len, dist_type),
            _ => eprintln!("unsupported element type"),
        },
