...
fn main() {
    ...
    match array.as_str() {
        ...
        "LocalLockArray" => match elem.as_str() {
            "u8" => fetch_and_test!(LocalLockArray, u8, len, dist_type),
            "u16" => fetch_and_test!(LocalLockArray, u16, len, dist_type),
            "u32" => fetch_and_test!(LocalLockArray, u32, len, dist_type),
            "u64" => fetch_and_test!(LocalLockArray, u64, len, dist_type),
            "u128" => fetch_and_test!(LocalLockArray, u128, len, dist_type),
            "usize" => fetch_and_test!(LocalLockArray, usize, len, dist_type),
            "i8" => fetch_and_test!(LocalLockArray, i8, len, dist_type),
            "i16" => fetch_and_test!(LocalLockArray, i16, len, dist_type),
            "i32" => fetch_and_test!(LocalLockArray, i32, len, dist_type),
            "i64" => fetch_and_test!(LocalLockArray, i64, len, dist_type),
            "i128" => fetch_and_test!(LocalLockArray, i128, len, dist_type),
            "isize" => fetch_and_test!(LocalLockArray, isize, len, dist_type),
            _ => eprintln!("unsupported element type"),
        },
        "GlobalLockArray" => match elem.as_str() {
            "u8" => fetch_and_test!(GlobalLockArray, u8, len, dist_type),
            "u16" => fetch_and_test!(GlobalLockArray, u16, len, dist_type),
            "u32" => fetch_and_test!(GlobalLockArray, u32, len, dist_type),
            "u64" => fetch_and_test!(GlobalLockArray, u64, len, dist_type),
            "u128" => fetch_and_test!(GlobalLockArray, u128, len, dist_type),
            "usize" => fetch_and_test!(GlobalLockArray, usize, len, dist_type),
            "i8" => fetch_and_test!(GlobalLockArray, i8, len, dist_type),
            "i16" => fetch_and_test!(GlobalLockArray, i16, len, dist_type),
            "i32" => fetch_and_test!(GlobalLockArray, i32, len, dist_type),
            "i64" => fetch_and_test!(GlobalLockArray, i64, len, dist_type),
            "i128" => fetch_and_test!(GlobalLockArray, i128, len, dist_type),
            "isize" => fetch_and_test!(GlobalLockArray, isize, len, dist_type),
            _ => {} // eprintln!("unsupported element type"),
        },
